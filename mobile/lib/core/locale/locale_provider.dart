...
final Map<String, String> _fallbackStringsRu = {
  ...
  'ffmi_low': 'Низкая мышечная масса',
  'ffmi_avg': 'Средний уровень',
  'ffmi_good': 'Хороший, спортивный уровень',
  'ffmi_excellent': 'Отличная мускулатура (атлет)',
  'ffmi_natural_limit': 'Предельный уровень для натурального тренинга',
  'ffmi_very_high': 'Обычно стероиды или исключительная генетика',
  'ffmi_no_height': '— (укажите рост)',
  'bmi_no_height': '— (укажите рост)',
  'bmi_severe_underweight': 'Выраженный дефицит массы тела',
  'bmi_underweight': 'Недостаточная масса тела',
  'bmi_normal': 'Норма',
  'bmi_overweight': 'Избыточная масса тела (предожирение)',
  'bmi_obese_1': 'Ожирение 1 степени',
  'bmi_obese_2': 'Ожирение 2 степени',
  'bmi_obese_3': 'Ожирение 3 степени',
...
final Map<String, String> _fallbackStrings = {
  ...
  'ffmi_low': 'Low muscle mass',
  'ffmi_avg': 'Average',
  'ffmi_good': 'Good, athletic level',
  'ffmi_excellent': 'Excellent musculature (athlete)',
  'ffmi_natural_limit': 'Natural training limit',
  'ffmi_very_high': 'Usually steroids or exceptional genetics',
  'ffmi_no_height': '— (set height)',
  'bmi_no_height': '— (set height)',
  'bmi_severe_underweight': 'Severe underweight',
  'bmi_underweight': 'Underweight',
  'bmi_normal': 'Normal',
  'bmi_overweight': 'Overweight (pre-obesity)',
  'bmi_obese_1': 'Obesity class 1',
  'bmi_obese_2': 'Obesity class 2',
  'bmi_obese_3': 'Obesity class 3',
