...
class ProgressWorkoutsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProgressWorkoutsScreen> createState() =>
      _ProgressWorkoutsScreenState();
}

class _ProgressWorkoutsScreenState
    extends ConsumerState<ProgressWorkoutsScreen> {
                    ...
                    children: [
                      ...
                      if (byTemplate.isNotEmpty) ...[
                        ...
                        Padding(
                          ...
                          child: Text(tr('no_workouts_for_template'),
